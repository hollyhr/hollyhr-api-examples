...
Small, safe and runnable examples are welcome.

Before opening a pull request:

1. Use synthetic data and placeholder credentials only.
2. Start read-only unless the example teaches a specific safety control.
